classdef me_twix_map_obj < handle
...
methods
    % Constructor:
    function this = me_twix_map_obj(arg,dataType,fname,version,rstraj)
...
%         end
    ...
    function versiontime = get.readerVersion(~)
        ...
        % fclose(fid);
        versiontime = uint64(str2double('1496740353')); %% MELLIOTT - dependency on finding this file was problematic!!
    end
